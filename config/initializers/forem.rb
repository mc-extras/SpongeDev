...
Forem.email_from_address = "info@jake0oo0.me"
...
# end
#
# By default, these lines will use the layout located at app/views/layouts/applicaiton.html.erb in your application.
